...
$liste = array();
array_push($liste, new cours(1, "Apprenez HTML", "EZ",null, -1, 1));
array_push($liste, new cours(2, "Allez plus loin avec HTML", "EZ",null, -1, 1));
array_push($liste, new cours(3, "Apprenez CSS", "WANNA KMS", null,-1, 2));
array_push($liste, new cours(4, "Apprenez JS", "EZ",null, -1, 3));
