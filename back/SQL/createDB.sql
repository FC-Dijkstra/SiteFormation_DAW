...
--
-- Hôte : 127.0.0.1
-- Généré le : Dim 04 avr. 2021 à 10:56
...
CREATE TABLE `admin` (`user` int(11) NOT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_bin;
-- --------------------------------------------------------
--
...
--
DROP TABLE IF EXISTS `fichiersevaluation`;
...
--
ALTER TABLE `cours`
ADD CONSTRAINT `fk_auteur_cours` FOREIGN KEY (`auteur`) REFERENCES `utilisateurs` (`id`) ON DELETE
SET NULL,
